...
public class DesafioFilter {
    ...
    public static void main(String[] args) {
        ...
        Produto p2 = new Produto("Elepachinga", 4899.99, 0.32, 0);
        Produto p3 = new Produto("Materiais nucleares", 1200, 0.45, 0);
        Produto p4 = new Produto("Notebook gamer", 30, 0.40, 0);
        Produto p5 = new Produto("6 meses de WoW", 3100, 0.30, 0);
        Produto p6 = new Produto("Relógio do ben 10", 1900, 0.12, 0);
        Produto p7 = new Produto("winx", 800, 0.31, 0);
